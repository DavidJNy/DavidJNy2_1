        ...
        <>
            <div id='Main' class='d-flex-inline'>
                <div class='d-flex position-relative p-5'>
                    ...
                    <h1 class='position-absolute p-3'>Here are PrickTox, we are here for your needs</h1>
                    ...
                    <h4 class='p-3 d-none d-lg-flex align-items-center'>I deliver unique customer experience with high level digital talent.</h4>
                ...
                <div class='d-flex flex-row-reverse p-5 justify-content-between'>
                    <img src={boymonk} alt='' class='img-fluid rounded float-right d-flex'/>
                    <div class='p-5'>
                        <h1 class='display-4'>Here at Pricktox</h1>
                        <hr class='my-4'></hr>
                ...
                <div class='d-flex p-5 justify-content-between'>
                    ...
                    <h1 class='display-4 d-flex p-3 align-items-center'>We care for you when you need it most</h1>
                </div>
            </div>
        </>
    );
